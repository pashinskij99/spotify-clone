...
export const shazamCoreApi = createApi({
  ...
  baseQuery: fetchBaseQuery({
    ...
    prepareHeaders: (headers) => {
      headers.set('X-RapidAPI-Key', 'e4fbbd8f6emsh81ef9f36282b49ep1f1856jsn0ed1a8870157')
  ...
  endpoints: (builder) => ({
    ...
    getSongsByCountry: builder.query({ query: ( counryCode ) => `/charts/country?country_code=${counryCode}` }),
